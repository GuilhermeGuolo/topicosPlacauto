...
public class ItensDao {
    ...
    public void update(Itens item) {
        ...
        try {
            conn = Conexao.getConnection();
            String sql = "update itens set nome, quantidade, tipo fabricante = ? where id_itens = ?";
            ps = conn.prepareStatement(sql);
            //ps.setInt(1, item.getIdItem());
    ...
    public static List<Itens> getAll(String codigo) {
        ...
        try {
            ...
            String sql = "select id_itens,nome, quantidade, tipo, fabricante from itens where id_itens = "+codigo;
            ps = conn.prepareStatement(sql);
